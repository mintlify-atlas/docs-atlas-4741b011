...
<CodeGroup>
```bash GET /api/categorias
curl https://api.beanquick.com/api/categorias
```
</CodeGroup>

Returns all product categories available on the platform.
...
<CodeGroup>
```bash GET /api/productos/destacados
curl https://api.beanquick.com/api/productos/destacados
```
</CodeGroup>

Returns the top 4 products with the highest average ratings across the platform.

**Response**

Returns an array of product objects with ratings:
